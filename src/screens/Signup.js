...
function Signup() {
    ...
    console.log('params on signup', params);
    ...
    }, [params, userName, valueEmail, valuePass, valueConfirmPass, contact]);
        ...
        <>
            ...
            >
                ...
                <>
                    ...
                    >
                        <Box>
                            <Typography variant="h4" style={{ textAlign: 'center', fontWeight: 'bold' }}>Signup</Typography>
                    ...
                    >
                        ...
                        />
                            ...
                            <Box className="p-2" style={{ textAlign: 'center', marginTop: 20 }}>
                                <Typography>Already have an account <Button
